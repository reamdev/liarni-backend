...
describe('JWT Test', () => {
  ...
  test('Get User Id By Bearer Token Test', () => {
    expect(getUserIdByToken('Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYyN2RmMzZiZWEzOWI4NWI1YjBhZDNjZCIsImlhdCI6MTY1MjQ1NzAwMCwiZXhwIjoxODEwMjQ1MDAwfQ.WF1dGXyzYeBUMc4Vn5A1N3QziBP5BiucqceC8H0lrhA')).toBe('627df36bea39b85b5b0ad3cd')
  })
})
